...
import { StorybookWrapper, StoryContainer, StoryHeader } from '../../utils/storybook';
import FocusTrap from './FocusTrap';

const readme = require('./README.md');

const story = storiesOf('Core|Foundations/FocusTrap', module).addDecorator(StorybookWrapper);
