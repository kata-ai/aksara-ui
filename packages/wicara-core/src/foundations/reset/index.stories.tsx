    ...
    return (
      <>
        <SystemHeader
          title="Colors"
          subtitle={
            <Paragraph m={0} scale="large" color="white">
              These are the primary colors used within the Aksara system.
            </Paragraph>
          }
        />
        <SystemContainer>
          ...
          <ColorSwatchGrid>
            <ColorSwatch
              title="Special 01"
              colorKey="special01"
              hex={themeProps.colors.special01}
            />
            <ColorSwatch
              title="Special 02"
              colorKey="special02"
              hex={themeProps.colors.special02}
            />
            <ColorSwatch
              title="Special 03"
              colorKey="special03"
              hex={themeProps.colors.special03}
            />
            <ColorSwatch
              title="Special 04"
              colorKey="special04"
              hex={themeProps.colors.special04}
            />
            <ColorSwatch
              title="Special 05"
              colorKey="special05"
              hex={themeProps.colors.special05}
            />
            <ColorSwatch
              title="Special 06"
              colorKey="special06"
              hex={themeProps.colors.special06}
            />
            <ColorSwatch
              title="Special 07"
              colorKey="special07"
              hex={themeProps.colors.special07}
            />
            <ColorSwatch
              title="Special 08"
              colorKey="special08"
              hex={themeProps.colors.special08}
            />
            <ColorSwatch
              title="Special 09"
              colorKey="special09"
              hex={themeProps.colors.special09}
            />
            <ColorSwatch
              title="Special 10"
              colorKey="special10"
              hex={themeProps.colors.special10}
            />
          </ColorSwatchGrid>
        </SystemContainer>
      </>
