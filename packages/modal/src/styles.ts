...
export const ModalBase = (props: WithThemeProps<ModalProps>) => css`
  display: block;
  position: fixed;
  top: 0;
  left: 0;
...
export const ModalContentStyles = (props: WithThemeProps<ModalProps>) => css`
  display: flex;
...
export const ModalDialogStyles = (props: WithThemeProps<ModalProps>) => css`
  position: relative;
  width: 100%;
  max-width: 500px;
  margin: 1.75rem auto;
